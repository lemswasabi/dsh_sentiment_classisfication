...
def main():
    ...
    with open('results/results_sentiment_with_punctuation_es_BC.pickle', 'wb') as handle:
    ...
    with open('results/results_topic_with_punctuation_es_BC.pickle', 'wb') as handle:
